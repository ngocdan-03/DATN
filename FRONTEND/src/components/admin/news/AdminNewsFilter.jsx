...
import { CATEGORY, STATUS } from "../../../constants/news";


const DEFAULT_FILTERS = { category: "", status: "" };

export default function AdminNewsFilter({ value = DEFAULT_FILTERS, onApply }) {
          ...
          <div className="bg-[linear-gradient(135deg,#041627_0%,#123456_100%)] px-5 py-4 text-white">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <h3 className="mt-1 text-lg font-black [font-family:Manrope]">Bộ lọc tin tức</h3>
              </div>
              <button
                type="button"
