...
public class RecommendService {
    ...
    public RecommendationListResponse getPersonalRecommendations() {
        ...
        try {
            ...
            Map<String, Object> requestBody = Map.of("userId", userId, "limit", 6);

            ResponseEntity<Map> response = restTemplate.postForEntity(
                    aiServerUrl + "/recommend/personal", requestBody, Map.class
            );
    ...
    private List<PostResponse> getFallbackTopViewPosts() {
        // Lấy top 6 bản ghi dùng PageRequest
        ...
        if (topPosts.isEmpty()) {
            topPosts = postRepository.findTop6ByStatusOrderByCreatedAtDesc(PostStatus.APPROVED);
        }
