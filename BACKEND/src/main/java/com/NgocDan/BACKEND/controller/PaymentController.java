...
public class PaymentController {
    ...
    public ApiResponse<PaymentResponse> createPayment(@RequestBody @Valid PaymentRequest paymentRequest, HttpServletRequest request) {
    ...
    public void paymentCallback(@RequestParam Map<String, String> queryParams, HttpServletResponse response) throws IOException {
        ...
        // Điều hướng
        String redirectUrl = String.format("http://localhost:5173/payment/result?status=%s&amount=%s&message=%s",
                result.getStatus(),
                result.getAmount(),
